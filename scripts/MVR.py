...
def MVR_MCMC_initialization(X_ij, one_n_j, K, a_0, b_0, seed_initialization):
...
def MVR_MCMC_step(one_hot_X, one_n_j, K, a_0, b_0, Z_ij, theta_j_k, g_i, g_0, sigma, seed_step):
...
def MVR_MCMC_from_start(X_ij, one_n_j, K, a_0, b_0, sigma, MCMC_iterations, seed_MCMC):
    ...
    # initialization 
    Z_ij, theta_j_k, g_i, g_0, nr_accepted = MVR_MCMC_initialization(X_ij, one_n_j, K, a_0, b_0, seed_initialization)
    ...
    def body(input, t):
        ...
        Z_ij, theta_j_k, g_i, g_0_new = MVR_MCMC_step(one_hot_X, one_n_j, K, a_0, b_0, Z_ij, theta_j_k, g_i, g_0, sigma, seed_step_to_split[t])
...
def MVR_MCMC_initialized(X_ij, one_n_j, K, a_0, b_0, sigma, initialization_MCMC, MCMC_iterations, seed_MCMC):
...
def MVR_MCMC_initialized_tau(X_ij, one_n_j, K, a_0, b_0, sigma, initialization_MCMC, N, MCMC_iterations, batch_size, seed_MCMC):
    ...
    def body(input, t):
        ...
        Z_ij, theta_j_k, g_i, g_0_new = MVR_MCMC_step(one_hot_X, one_n_j, K, a_0, b_0, Z_ij, theta_j_k, g_i, g_0, sigma, seed_step_without_tau)
