...
input_path =  "DisclosureRisk/Data/NY/clean/"
output_path = "DisclosureRisk/Data/NY/clean/BNP/mc/"+str(n)+"/"
...
X_ij    = tf.convert_to_tensor(np.load(input_path+"NY_X_ij_"+str(n)+".npy"), dtype = tf.int32)
