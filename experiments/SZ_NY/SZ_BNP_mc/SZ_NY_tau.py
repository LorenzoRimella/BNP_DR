...
output_path = "DisclosureRisk/Data/NY/structural_zeros/SZ_BNP_sample_"+str(seed_to_use)+"/mc/"+str(n)+"/"
...
string = ["Start MCMC with seed "+str(seed_to_use)+" and n "+str(n), "\n"]
