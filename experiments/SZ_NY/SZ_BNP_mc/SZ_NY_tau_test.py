...
from BNP import *
from BNP_structural_zeros_generate_data import *

task_id =  0 # int(os.getenv("SLURM_ARRAY_TASK_ID"))-1

n = [1000, 5000, 10000][task_id]
input_path =  "DisclosureRisk/Data/NY/synthetic_generated_structural_zeros/"
output_path = "DisclosureRisk/Data/NY/synthetic_generated_structural_zeros/SZ_BNP/mc/"+str(n)+"/"
...
X_ij    = tf.convert_to_tensor(np.load(input_path+"X_ij_"+str(n)+".npy"), dtype = tf.int32)
