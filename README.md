...
data, containing all the input and output data of our experiments:
...
experiments, containing all the experiments we run for the paper:
...
scripts, which contains all the .py files to run our method:
